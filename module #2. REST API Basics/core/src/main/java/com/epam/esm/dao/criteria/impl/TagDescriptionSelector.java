...
public class TagDescriptionSelector implements GiftCertificateSelector {
    ...
    public List<GiftCertificate> select(String tagName, String name, String description, JdbcTemplate jdbcTemplate,
        ...
        return jdbcTemplate.query(SELECT_BY_TAG_AND_DESCRIPTION, giftMapper, description, tagName);
    }
}
